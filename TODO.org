...
** NEXT Rewrite to nix2container :enhancements:
...
* Done
** DONE Forward to default search engine :features:
CLOSED: [2025-10-13 Mon 17:59]
...
CLOSED: [2025-10-13 Mon 17:58]
** DONE Add models :enhancements:
CLOSED: [2025-10-13 Mon 17:59]
...
** CANCELLED Implement weights :features:
Since we don't really search anymore it doens't make sense to implement this.
CLOSED: [2025-10-13 Mon 17:59]
...
** CANCELLED Implement flake-utils :bugs:
CLOSED: [2026-04-14 Tue 22:54]

I'm moving away from aarch64

I need proper multi-arch support in this repo because I build container images for aarch64-linux but I develop the whole thing on x86_64-linux.
