...
@pytest.fixture
def bang(user: "SearchUser", db) -> Bang:
...
def test_resolve_bang_with_query(user: "SearchUser", bang: Bang) -> None:
...
def test_resolve_bang_with_empty_query(user: "SearchUser", bang: Bang) -> None:
...
def test_resolve_bang_only_shortcut_no_space(user: "SearchUser", bang: Bang) -> None:
...
def test_resolve_bang_url_encoding(user: "SearchUser", bang: Bang) -> None:
...
def test_resolve_bang_strips_whitespace(user: "SearchUser", bang: Bang) -> None:
