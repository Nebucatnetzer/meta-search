...
manifest-tool --username $REGISTRY_USER --password $REGISTRY_PASS push from-args --platforms linux/arm64/v8 --template "${REGISTRY,,}"/zweili-search-app:latest --target "${REGISTRY,,}"/zweili-search-app:latest
